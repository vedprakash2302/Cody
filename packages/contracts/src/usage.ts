 ...
 * `~/.grok/sessions/**\/updates.jsonl`, OpenCode's `opencode.db`) rather than relying on T3 Code's own
 ...
 *
 * v5 and v6 only add `grok` and `opencode` to {@link UsageProviderKind}; v4
