...
const DESKTOP_APP_ID = "com.vedpandey.cody";
...
export const resolveGitHubPublishConfig = Effect.fn("resolveGitHubPublishConfig")(function* (
  ...
  // Fork builds must opt into their own feed, never inherit T3's release feed.
  const updateRepository = yield* Config.String("CODY_DESKTOP_UPDATE_REPOSITORY").pipe(
    Config.option,
  );
...
export const createBuildConfig = Effect.fn("createBuildConfig")(function* (
  ...
  const buildConfig: Record<string, unknown> = {
    ...
    artifactName: "Cody-${version}-${arch}.${ext}",
    // null prevents electron-builder from inferring an upstream GitHub feed.
    publish: null,
    ...
    buildConfig.mac = {
      ...
      extendInfo: {
        NSScreenCaptureUsageDescription:
          "Cody captures the active window when you use the window capture shortcut.",
      },
      protocols: [
        {
          name: "Cody",
          schemes: ["cody", "cody-dev"],
        },
      ],
  ...
  if (platform === "linux") {
    buildConfig.linux = {
      ...
      // cody:// OAuth callbacks to the app.
      protocols: [
        {
          name: "Cody",
          schemes: ["cody", "cody-dev"],
...
const buildDesktopArtifact = Effect.fn("buildDesktopArtifact")(function* (
  ...
  const stagePackageJson: StagePackageJson = {
    ...
    private: true,
    packageManager: rootPackageJson.packageManager,
    description: "Cody desktop build",
    // Required by the .deb control file.
    homepage: "https://github.com/vedprakash2302/Cody",
    author: "T3 Tools",
