export const BRAND_ASSET_PATHS = {
  ...
  productionWebFaviconIco: "assets/cody/icon.ico",
  productionWebFavicon16Png: "assets/cody/icon-16.png",
  productionWebFavicon32Png: "assets/cody/icon-32.png",
  productionWebAppleTouchIconPng: "assets/cody/icon-180.png",
  ...
  nightlyWebFaviconIco: "assets/cody/icon.ico",
  nightlyWebFavicon16Png: "assets/cody/icon-16.png",
  nightlyWebFavicon32Png: "assets/cody/icon-32.png",
  nightlyWebAppleTouchIconPng: "assets/cody/icon-180.png",

  developmentDesktopIconPng: "assets/dev/blueprint-macos-1024.png",
  developmentWindowsIconIco: "assets/dev/blueprint-windows.ico",
  developmentWebFaviconIco: "assets/cody/icon.ico",
  developmentWebFavicon16Png: "assets/cody/icon-16.png",
  developmentWebFavicon32Png: "assets/cody/icon-32.png",
  developmentWebAppleTouchIconPng: "assets/cody/icon-180.png",
} as const;
