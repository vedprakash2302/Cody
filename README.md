...
Cody is Ved's personal fork of [T3 Code](https://github.com/pingdotgg/t3code), combining upstream updates with personal fixes. Download Cody from [this fork's releases](https://github.com/vedprakash2302/Cody/releases).

Desktop builds from this checkout install as Cody and can run
alongside the official T3 Code app, including Nightly. Cody keeps its conversations and
settings in `~/.cody/userdata`, including inside WSL, and uses a separate Electron profile.
